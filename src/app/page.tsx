...
export default function Home() {
  ...
  return (
    <div
      ...
      style={{ backgroundImage: `url('images/Paper 4.webp')` }}
    >
      <div className="absolute top-[8%] md:top-[10%] left-1/2 transform -translate-x-1/2 -translate-y-1/2 flex flex-col items-center z-10">
        <Image
          ...
          alt="mascots"
          width={isMobile ? 239 : 462}
          height={isMobile ? 79 : 154}
        />
      ...
      <Image
        ...
        height={isMobile ? 450 : 933}
        className="h-[50vh] w-[100vw] md:h-[100vh] md:w-[95vw] z-20"
      />
      {!isMobile && (
        <Image
          src="/images/white_strip.webp"
          alt="strip"
          width={1230}
          height={748}
      ...
      <div className="mt-[30rem] md:mt-40 pl-4 md:pl-32 pr-0 relative">
        <div className="bg-black py-1.5 px-3 inline-block">
          <h2 className="font-handwriting text-white text-lg md:text-2xl">
            WHAT WE DO
          </h2>
        </div>
